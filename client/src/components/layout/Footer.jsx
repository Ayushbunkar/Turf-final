      ...
      >
        ...
        <div className="bg-white/5 p-6 rounded-xl backdrop-blur-md border border-white/10 shadow-lg">
          ...
          <div className="flex space-x-4 mt-4">
            {[
              { icon: <FacebookIcon size={20} />, link: '#' },
              { icon: <TwitterIcon size={20} />, link: '#' },
              { icon: <InstagramIcon size={20} />, link: '#' }
            ].map((social, idx) => (
              <motion.a
                key={idx}
                href={social.link}
        ...
        <div className="bg-white/5 p-6 rounded-xl backdrop-blur-md border border-white/10 shadow-lg">
          ...
          <ul className="space-y-4 text-gray-300 text-sm">
            <li className="flex items-start">
              <MapPinIcon size={20} className="text-green-500 mr-3 mt-1" />
              <span>123 Sports Avenue, Stadium District, City, 12345</span>
            </li>
            <li className="flex items-center">
              <PhoneIcon size={20} className="text-green-500 mr-3" />
              <span>+1 (555) 123-4567</span>
            </li>
            <li className="flex items-center">
              <MailIcon size={20} className="text-green-500 mr-3" />
