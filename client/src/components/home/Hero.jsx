  ...
  return <div className="relative min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        ...
        duration: 1.5
          ...
          <img src="https://images.unsplash.com/photo-1574629810360-7efbbe195018?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1936&q=80" alt="Football turf" className="w-full h-full object-cover" />
        </motion.div>
        <div className="absolute inset-0 bg-black bg-opacity-60"></div>
        {/* Animated Particles */}
        <div className="absolute inset-0 overflow-hidden">
          {[...Array(20)].map((_, i) => <motion.div key={i} className="absolute w-2 h-2 rounded-full bg-green-400 opacity-70" initial={{
          x: Math.random() * 100 + '%',
          y: Math.random() * 100 + '%',
      ...
      <div className="container mx-auto px-4 z-10 pt-16">
        <div className="max-w-3xl">
          ...
          duration: 0.8
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">
              Book Your Perfect{' '}
              <motion.span className="text-green-500 inline-block" animate={{
              rotateX: [0, 15, 0],
              scale: [1, 1.05, 1]
            }} transition={{
              duration: 3,
        ...
        <motion.div className="hidden lg:block absolute right-20 bottom-20" initial={{
        opacity: 0,
        scale: 0.8,
        rotateZ: -15
      }} animate={{
        ...
        delay: 0.8
          ...
          <motion.div className="w-32 h-32 relative" animate={{
          rotateY: 360,
          rotateZ: [0, 10, -10, 0]
        }} transition={{
          rotateY: {
          ...
          rotateZ: {
            ...
            <div className="w-full h-full rounded-full bg-white shadow-[0_0_40px_rgba(74,222,128,0.6)] relative">
              ...
              <div className="absolute inset-[10px] rounded-full bg-gradient-to-br from-white to-gray-200 flex items-center justify-center">
                ...
                <div className="absolute w-full h-full rounded-full">
                  {[...Array(5)].map((_, i) => <div key={i} className="absolute w-4 h-4 rounded-full bg-black opacity-80" style={{
                  top: `${20 + Math.sin(i * 72 * Math.PI / 180) * 30}%`,
                  left: `${50 + Math.cos(i * 72 * Math.PI / 180) * 30}%`
                }}></div>)}
                  {[...Array(6)].map((_, i) => <div key={i} className="absolute w-[2px] h-[40%] bg-black opacity-60 origin-bottom" style={{
                  top: '10%',
                  left: '50%',
            ...
            {/* Glow effect */}
            <motion.div className="absolute inset-0 rounded-full bg-green-500 opacity-30 blur-md" animate={{
            scale: [1, 1.2, 1]
          }} transition={{
            duration: 2,
            repeat: Infinity
